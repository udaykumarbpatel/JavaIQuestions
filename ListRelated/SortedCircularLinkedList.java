...
class CircularList {
	...
	public CircularList(int k) {
		value = k;
		next = this;// point to itself for creating a new instance, need
					// manually adjust tail's next to head
	}
	...
	public void printList() {
		if (this == null)
			return;
		// otherwise, we copy the current head reference, iterate the list until
		// we meet the head
